...
import com.urbanbloom.user.domain.Email;
import com.urbanbloom.user.domain.ExternalUserId;
import com.urbanbloom.user.domain.IdentityProvider;
import com.urbanbloom.user.domain.PasswordResetCompleted;
import com.urbanbloom.user.domain.PasswordResetException;
import com.urbanbloom.user.domain.PasswordResetRequested;
import com.urbanbloom.user.domain.UserName;
import com.urbanbloom.user.domain.UserProfile;
import com.urbanbloom.user.domain.UserProfileRepository;
