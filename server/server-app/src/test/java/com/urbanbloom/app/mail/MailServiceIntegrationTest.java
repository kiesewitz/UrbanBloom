package com.urbanbloom.app.mail;
 ...
 * - MAIL_FROM: The sender address (optional, defaults to noreply@urbanbloom.local)
 * 
 * To run this test:
 ...
 *    export MAIL_FROM=noreply@urbanbloom.local
...
class MailServiceIntegrationTest {
    ...
    @Value("${app.mail.from:noreply@urbanbloom.local}")
     ...
     * mvn test -pl server-app -Dtest=MailServiceIntegrationTest#testSendSimpleTestEmail
     */
    @Test
